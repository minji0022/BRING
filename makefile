...
rsa : bignum.dylib rsa_pss/rsatest.c rsa_pss/rsa.c rsa_pss/rsa_pss.c rsa_pss/sha256.c
	$(CC) -Wall -g rsa_pss/rsatest.c rsa_pss/rsa.c rsa_pss/rsa_pss.c rsa_pss/sha256.c -o rsa_pss/rsatest bignum.dylib
#./rsatest > rsatest.exe
